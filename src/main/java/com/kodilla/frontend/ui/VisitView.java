...
public class VisitView extends VerticalLayout implements AfterNavigationObserver, HasUrlParameter<Long> {
    ...
    public VisitView() {
        ...
        HorizontalLayout toolbar = new HorizontalLayout(filterText,
                addNewVisitBtn);
        HorizontalLayout mainContent = new HorizontalLayout(grid, visitForm,visit_medicationForm);
    ...
    public void addMedication(Long visitId){
        visit_medicationForm.setVisit_Medication(new Visit_Medication());
    }

    public void addVaccination(Long visitId){
        visit_vaccinationForm.setVisit_Vaccination(new Visit_Vaccination());
    }
